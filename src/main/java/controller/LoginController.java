...
public class LoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user != null) {
            ...
            Cookie ckRoleName = new Cookie("roleName", user.getRoleName());
            ckRoleName.setMaxAge(60 * 60 * 24);
            ckRoleName.setHttpOnly(true);
            resp.addCookie(ckRoleName);
            if (remember != null) {
