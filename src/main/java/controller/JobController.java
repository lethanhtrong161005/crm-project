...
public class JobController extends HttpServlet {
    ...
    private void loadJobDetail(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
        String id = req.getParameter("id");
        HashMap<String, Double> map = service.getJobStatusPercentage(id);
        req.setAttribute("jobStatusMap", map);
        List<JobDTO> jobList = service.getTaskDetailsByJobAndStatusById(id);
