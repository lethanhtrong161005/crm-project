...
public class UserService {
    ...
    public List<UserTaskStatusSummaryDTO> getUserTaskStatusSummaryByUserEmail(String email){
        return usersRepository.findUserTaskStatusSummaryByUserEmail(email);
    }
    public String getFullNameByEmail(String email) {
        return usersRepository.findFullnameByUserEmail(email);
    }
    public UserTaskStatusDTO getgetUserTaskCompletionPercentageByUserEmail(String email) {
        return usersRepository.findUserTaskCompletionPercentageByEmail(email);
    }
}
