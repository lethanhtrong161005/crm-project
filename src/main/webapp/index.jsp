                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="./home">Thống kê công việc</a></li>
                                <li class="divider"></li>
                        ...
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 class="counter text-right m-t-15 text-danger">
                                    <c:forEach var="item" items="${userTaskStatusSummaryList}">
                                        <c:if test="${item.statusName == 'Chưa thực hiện'}">${item.taskCount}</c:if>
                                    </c:forEach>
                                </h3>
                            </div>
                        ...
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 class="counter text-right m-t-15 text-megna">
                                    <c:forEach var="item" items="${userTaskStatusSummaryList}">
                                        <c:if test="${item.statusName == 'Đang thực hiện'}">${item.taskCount}</c:if>
                                    </c:forEach>
                                </h3>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-in row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 class="counter text-right m-t-15 text-primary">
                                    <c:forEach var="item" items="${userTaskStatusSummaryList}">
                                        <c:if test="${item.statusName == 'Đã hoàn thành'}">${item.taskCount}</c:if>
                                    </c:forEach>
                                </h3>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
