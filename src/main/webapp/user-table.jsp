                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/crm_project_war_exploded/users?id=${item.id}" class="btn btn-sm btn-danger">Xóa</a>
                                                <a href="/crm_project_war_exploded/user-details?id=${item.id}"class="btn btn-sm btn-info">Xem</a>
                                            </td>
                                        </tr>
                                    	</c:forEach>
