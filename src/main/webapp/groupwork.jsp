                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tbody>
										<c:forEach var="item" items="${listJob}" varStatus="status">
											<tr>
												<td>${status.count}</td>
												<td>${item.name}</td>
												...
												<td><a href="#" class="btn btn-sm btn-primary">Sửa</a>
													<a href="/crm_project_war_exploded/jobs?id=${item.id}" class="btn btn-sm btn-danger">Xóa</a> <a
													href="/crm_project_war_exploded/job-details?id=${item.id}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
